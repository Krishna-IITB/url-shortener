        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 xl:gap-16 items-start">
          ...
          <motion.div className="lg:col-span-6 space-y-7 sm:space-y-9">
            ...
            <motion.form
              ...
              initial={{ opacity: 0, y: 50 }}
              animate={{ opacity: 1, y: 0 }}
              className="relative glass-card rounded-3xl p-4 sm:p-6 md:p-8 shadow-2xl animate-float-slow origin-top-left"
              whileHover={{ rotate: -1.5, y: -4 }}
            >
              <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-indigo-500/10 via-purple-500/5 to-emerald-400/10" />

              {/* small caption so the card is self‑explaining */}
              <div className="relative mb-2 flex items-center gap-2 text-[10px] sm:text-xs text-slate-400">
                <span className="inline-flex h-1.5 w-1.5 rounded-full bg-emerald-400 animate-pulse-soft" />
                <span>Paste any long URL to generate a smart link</span>
              </div>
