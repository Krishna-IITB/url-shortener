...
//   const { total_clicks, unique_ips, clicks_by_date, device_breakdown } = stats;
//   const clickRate =
...
//         {/* Device breakdown simple list (can chart later) */}
//         <div className="bg-slate-800 rounded-lg p-4">
//           <p className="mb-3 text-sm text-slate-300">Device Breakdown</p>
...
//                 <span className="text-slate-100 font-medium">{d.count}</span>
//               </div>
//             ))}
//           </div>
//         </div>
